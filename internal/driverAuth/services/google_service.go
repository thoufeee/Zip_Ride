...
// GoogleLogin verifies the Google id_token, upserts a driver, and returns token, status, and phoneVerified
func GoogleLogin(idToken string) (string, string, bool, error) {
	...
	return token, d.Status, d.PhoneVerified, nil
}
